...
public class ExpertoLogin
{
    ...
    public List<DTOUsuarioLab> buscarUsuario(DTOUsuarioLab DtoNombre){
        List<DTOUsuarioLab> listaDTOUsuario = new ArrayList<>();
        ...
        criterio2.setAtributo("estadoUsuario");
        ...
        for(Object us: listaTI){
            DTOUsuarioLab dtoUL = new DTOUsuarioLab();
      ...
      /*Lista de usuario para el login
        List<DTOCriterio> criterioList1 = new ArrayList<>();
        DTOCriterio criterio1 = new DTOCriterio();
        criterio1.setAtributo("usuario");
        criterio1.setOperacion("=");
        criterio1.setValor(DtoNombre.getUsuario());
        criterioList1.add(criterio1);

        usuario  = (UsuarioLab) FachadaPersistencia.getInstance().buscar("UsuarioLab", criterioList1).get(0);
        
        DTOUsuarioLab user1 = new DTOUsuarioLab();       
        
        user1.setUsuario(usuario.getNombreUsuario());
        user1.setContraseña(usuario.getCntraseña());
        List<DTOUsuarioLab>  dtoUS = new ArrayList();
        dtoUS.add(user1);*/
        /*List<DTOCriterio> criterioList2 = new ArrayList<>();
        DTOCriterio criterio2 = new DTOCriterio();
